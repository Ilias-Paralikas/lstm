...
def train(model,epochs,train_dataloader,lr,criterion=None,optimizer=None,save_folder=None):
...
def plot_results(model,dataset,dataloader,time_step,device='cpu',save_folder=None):
