...
import json
from utils.model import LSTMModel, train,plot_results
...
train(model,epochs=EPOCHS,train_dataloader=train_dataloader,lr=lr,save_folder=run_folder)
plot_results(model,test_dataset,test_dataloader,time_step=TIME_STEP,device=device,save_folder=run_folder)
